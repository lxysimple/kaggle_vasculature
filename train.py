...
class CFG:
    ...
    train_batch_size = 16*2 # 16 # 训练批量大小
    ...
    checkpint = '/home/xyli/kaggle/kaggle_vasculature/workplace/se_resnext50_32x4d_4_loss0.25_score0.72_val_loss0.23_val_score0.86.pt'
